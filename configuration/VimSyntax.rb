class VimSyntax
  Scripts =
    [
     ...
     ['aap', 'A-A-P recipe'],
     ['abap', 'SAP - ABAP/R4'],
     ['abaqus', 'Abaqus finite element input file'],
     ...
     ['apachestyle', 'Apache-Style configuration files'],
     ...
     ['csc', 'Essbase script'],
     ['csh', 'C-shell (csh)'],
     ['csp', 'CSP (Communication Sequential Processes/FDR)'],
     ...
     ['dtrace', 'D script ("Solaris Dynamic Tracing Guide"),'],
     ['dylan', 'Dylan'],
     ['dylanintr', 'Dylan'],
     ...
     ['form', 'FORM'],
     ['forth', 'FORTH'],
     ['fortran', 'Fortran95/Fortran90/Fortran77/F/elf90)'],
     ...
     ['kix', 'KixTart 95, Kix2001 Windows script language'],
     ['kscript', 'kscript'],
     ['kwt', 'kimwitu++'],
     ['lace', 'lace'],
     ['latte', 'Latte'],
     ...
     #['masm', 'Microsoft Macro Assembler', true],
     ['masm', 'MASM', true],
     ...
     ['tf', 'tf'],
     ['tidy', 'HMTL Tidy configuration file'],
     ['tilde', 'Tilde'],
